...
define config.name = _("There is no god in Hinterland")
...
define config.main_menu_music = "sounds/main_menu_background.mp3"
...
define config.save_directory = "Thereisnogodhere-1597092977"
